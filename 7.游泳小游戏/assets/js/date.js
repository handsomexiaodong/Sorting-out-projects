...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        function refreshDate(){
            ...
            dayScroll.refresh();
            resetInitDete();
            yearScroll.scrollTo(0, initY*80, 100, true);
            monthScroll.scrollTo(0, initM*80-80, 100, true);
            dayScroll.scrollTo(0, initD*80-80, 100, true);
        }
        ...
        function resetInitDete(){
            ...
            initD = parseInt(that.val().substr(5,2));
        }
        function bindButton(){
            resetIndex();
            ...
            var str = ''+
                ...
                '</footer>'+
                    '<section>'+
                        ...
                        '<div id="datescroll">'+
                            '<div id="yearwrapper" class="DshowPop">'+
                                '<ul></ul>'+
                            '</div>'+
                            '<div id="monthwrapper"  class="DshowPop">'+
                                '<ul></ul>'+
                            '</div>'+
                            '<div id="daywrapper"  class="DshowPop">'+
                                '<ul></ul>'+
                            '</div>'+
                        '</div>'+
